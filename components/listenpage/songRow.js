	...
	return (
		<div className="flex items-center gap-4 border-b border-zinc-800 py-3">
			<SongAlbumCover
				...
				cover={cover}
			/>
			<div className="w-20 flex-shrink-0 text-center text-sm text-zinc-400">
				Played at {displayTime}
			</div>
			<div className="min-w-0 flex-1">
				<div className="font-courierprime text-white">{displaySong}</div>
				<div className="font-courierprime text-sm italic text-zinc-300">
					{displayArtist}
				</div>
				<div className="font-courierprime text-xs text-zinc-500">
					{displayAlbum}
				</div>
			</div>
		</div>
